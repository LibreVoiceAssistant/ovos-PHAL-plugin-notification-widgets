...
PLUGIN_ENTRY_POINT = 'ovos-PHAL-plugin-notification-widgets=ovos_PHAL_plugin_notification_widgets:OVOSNotificationWidgetsPlugin'
setup(
    ...
    license='Apache-2.0',
    packages=['ovos_PHAL_plugin_notification_widgets'],
